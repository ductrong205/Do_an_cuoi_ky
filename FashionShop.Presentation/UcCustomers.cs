    ...
    public partial class UcCustomers : UserControl, IReloadable
    {
        ...
        private void Wire()
        {
            ...
            btnSave.Click += (s, e) =>
            {
                var c = GetSelected();
                if (c == null) return;
                MessageBox.Show("Màn này demo hiển thị. Nếu muốn sửa dữ liệu thật, mình sẽ đổi Label -> TextBox.");
            };
        ...
        private void SeedDemo()
        {
            ...
            {
                new Customer("C001","Nguyễn Thị Mai","0912 345 678","mai.nguyen@gmail.com", new DateTime(2021,5,12), true, "Gold Member"),
                new Customer("C002","Trần Văn Hùng","0988 777 666","hung.tran@gmail.com", new DateTime(2022,3,2), false, "Silver Member"),
                new Customer("C003","Lê Thị Lan","0909 000 111","lan.le@gmail.com", new DateTime(2023,1,10), false, "Member"),
                new Customer("C004","Phạm Văn Minh","0812 345 678","minh.pham@gmail.com", new DateTime(2020,11,28), true, "Gold Member"),
            };

            for (int i = 0; i < _all.Count; i++)
                _all[i].Avatar = MakeAvatar(_all[i].Name);

            _all[0].History.Add(new Purchase("#ORD-1024", new DateTime(2023, 5, 20, 14, 30, 0), "Đầm dạ hội + Phụ kiện", 2450000));
            _all[0].History.Add(new Purchase("#ORD-0998", new DateTime(2023, 5, 2, 9, 15, 0), "Áo Blazer Hàn Quốc", 890000));

            _all[1].History.Add(new Purchase("#ORD-1101", new DateTime(2023, 6, 1, 10, 0, 0), "Quần Jeans Slimfit", 1200000));
            _all[2].History.Add(new Purchase("#ORD-1205", new DateTime(2023, 7, 12, 16, 40, 0), "Áo sơ mi trắng", 350000));
        }
        ...
        private void ShowSelectedCustomer()
        {
            ...
            lbRankValue.ForeColor = c.RankText.Contains("Gold") ? Color.Gold
                : (c.RankText.Contains("Silver") ? Color.Silver : C_TEXT);

            // an toàn null (phòng lúc UI chưa build xong)
